...
for itr_1 in range(MAX_ITERATION):
    print("ver4_1_timeslot15_MAX_ITERATION: %d, Harvesting_efficiency: %f" % (MAX_ITERATION,par.Harvesting_efficiency))
...
np.save('/home/mukim/Desktop/label/ver4_1_time15_label_reali_5_itr_10000_eff_0_7_result_table.npy',result_table)
np.save('/home/mukim/Desktop/label/ver4_1_time15_label_reali_5_itr_10000_eff_0_7.npy',real_label)
