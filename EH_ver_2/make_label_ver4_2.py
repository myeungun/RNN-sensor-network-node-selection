...
for itr_1 in range(MAX_ITERATION):
    print("ver4_2_MAX_ITERATION: %d, Harvesting_efficiency: %f" % (MAX_ITERATION,par.Harvesting_efficiency))
    ...
    for itr_2 in range(par.N_realization):
        ...
        for flow in range(h_UE_time.shape[1]/par.N_time):
            ...
            battery, delay, future_decision = find_the_best_decision_for_the_realization(h_UE_time[:,par.N_time*flow:par.N_time*flow+par.N_time],par, exist_ind,battery, delay)
...
np.save('/home/mukim/Desktop/EH_ver_2/label/ver4_2_label_reali_5_itr_1000_eff_0_7_result_table.npy',result_table)
np.save('/home/mukim/Desktop/EH_ver_2/label/ver4_2_label_reali_5_itr_1000_eff_0_7.npy',real_label)
