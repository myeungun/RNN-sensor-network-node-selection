...
import itertools
import random
from blackbox_module_for_test_ver3 import BB_module
...
x = np.loadtxt('/home/mukim/Desktop/EH_ver_2/training_data/training_channel_ver3_label_15timeslot_reali_5_itr_5000_eff_0_7.csv', delimiter=',')
y = np.loadtxt('/home/mukim/Desktop/EH_ver_2/training_data/training_decision_ver3_label_15timeslot_reali_5_itr_5000_eff_0_7.csv', delimiter=',')
...
ten_times_total_existence_of_penalty = np.zeros(shape=(test_size, par.N_schemes,1000))
...
for test_num in range(1000):
    ...
    with tf.Session() as sess:
        ...
        save_step_loss = np.zeros(shape=(iterations,))
        # Training step
        for i in range(iterations):
            _, step_loss = sess.run([train, loss], feed_dict={X: trainX, Y: trainY})
            print("[step: {}] loss: {}".format(i, step_loss))

            save_step_loss[i] = step_loss

        plt.plot(save_step_loss, label='loss')
        ...
        ten_times_total_existence_of_penalty[:,:,test_num] = total_existence_of_penalty

        print(test_num)

np.save('/home/mukim/Desktop/EH_ver_2/0.npy',ten_times_total_existence_of_penalty)

    #np.save('/home/mukim/Desktop/EH_ver_2/ver3_1_5000_15time_total_existence_of_penalty_1.npy',total_existence_of_penalty)
    #np.save('/home/mukim/Desktop/EH_ver_2/ver3_1_5000_15time_total_each_time_existence_of_penalty.npy', total_each_time_existence_of_penalty)
    #np.save('/home/mukim/Desktop/EH_ver_2/ver3_1_5000_15time_total_each_UE_each_penalty_info.npy', total_each_UE_each_penalty_info)
